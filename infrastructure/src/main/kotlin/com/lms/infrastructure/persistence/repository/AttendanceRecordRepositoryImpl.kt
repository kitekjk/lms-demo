...
class AttendanceRecordRepositoryImpl(
    private val jpaRepository: AttendanceRecordJpaRepository
    ...
    override fun findByEmployeeIdAndDate(employeeId: EmployeeId, date: LocalDate): AttendanceRecord? {
        return jpaRepository.findByEmployeeIdAndAttendanceDate(employeeId.value, date)
    ...
    override fun findByEmployeeIdAndDateRange(
        ...
        return jpaRepository.findByEmployeeIdAndAttendanceDateBetween(
            employeeId.value,
            startDate,
            endDate
        ).map { AttendanceRecordMapper.toDomain(it) }
